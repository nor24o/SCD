...
public class TicTacToe extends JPanel
{
    ...
    JButton buttons_controll[] = new JButton[3];
    ...
    public void initializare_controll_buttons()
    {
        for(int i = 0; i <= 2; i++){
            buttons_controll[i] = new JButton();
            buttons_controll[i].setText("Hello "+i);
            buttons_controll[i].addActionListener(new buttonListener());

            add(buttons_controll[i]); //adds this button to JPanel (note: no need for JPanel.add(...)
        }
    }
