...
//construieste tabela FLRS pentru doua intrari si doua iesiri

    Map<FuzzyValue, Map<FuzzyValue, FuzzyValue>> firstTable;
    Map<FuzzyValue, Map<FuzzyValue, FuzzyValue>> secondTable;

    public TwoXTwoTable(Map<FuzzyValue, Map<FuzzyValue, FuzzyValue>> firstTable, Map<FuzzyValue, Map<FuzzyValue, FuzzyValue>> secondTable) {
        this.firstTable = firstTable;
        this.secondTable = secondTable;
    }

//implementarea executiei tabelei FLRS
