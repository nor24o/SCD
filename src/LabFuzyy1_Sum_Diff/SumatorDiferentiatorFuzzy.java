...
public class SumatorDiferentiatorFuzzy {
...
//construim tabela2 FLRS pentru Sumator/Diferentiator, a doua iesire
...
//se afiseaza rezultatele defuzificate
        ...
        System.out.println("Sumator : x3 :: " + fuzDefuz.defuzzify(out[0]));
        System.out.println("Diferentiator : x4 :: " + fuzDefuz.defuzzify(out[1]));
